...
public class CastPoll extends HttpServlet {
   ...
   public synchronized void doPost(
      ...
      try {
         ...
         try {
            poll_id = Integer
                  .parseInt((String) request.getParameter("poll_id"));
         ...
         myTable.addUpdateFieldNameValuePair("poll_option_count", number_votes
               + "", "int");
         myTable.setSCustomWhere("and polls_data_id = " + response_id);
         myTable.updateRecord();
         ...
         myTable.addUpdateFieldNameValuePair("ip_address", (String) request
