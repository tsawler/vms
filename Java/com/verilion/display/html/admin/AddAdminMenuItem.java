...
public class AddAdminMenuItem extends SecurePage {
	...
	public void BuildPage(HttpServletRequest request,
		...
		try {
			...
			theMenu = HTMLFormDropDownList.makeDropDownListSnippet("page_id",
					0, crs, "page_id", "page_name", 0, "Does not link");
			...
			theMenu = HTMLFormDropDownList.makeDropDownListSnippet("parent_id",
					0, crs, "admin_menu_items_id", "admin_menu_items_name", 0,
					"Top level item");
			...
			e.printStackTrace();
			Errors.addError("AddAdminMenuItem:BuildPage:Exception:"
					+ e.toString());
		}
	}
}