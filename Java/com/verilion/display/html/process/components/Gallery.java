...
//------------------------------------------------------------------------------
//$Log: Gallery.java,v $
//Revision 1.1.2.5  2009/07/22 16:29:32  tcs
//*** empty log message ***
//
//Revision 1.1.2.4  2008/09/01 21:11:42  tcs
//*** empty log message ***
//
//Revision 1.1.2.3  2007/10/30 17:44:19  tcs
//Preliminary pagination added; added styled div wrapper
//
//Revision 1.1.2.2  2007/06/15 16:18:16  tcs
//Minor fix
//
//Revision 1.1.2.1  2007/06/14 12:46:37  tcs
//Initial entry
//
//------------------------------------------------------------------------------
...
public class Gallery extends ProcessPage {
	...
	public HTMLTemplateDb ProcessForm(HttpServletRequest request,
		...
		try {
			...
			myTableObject.setSCustomWhere(" and gd.gallery_id = " 
					+ id
					+ " and img <> ''");
			if (hm.get("lim") != null)
