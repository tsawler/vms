...
public class QBETag extends BaseTag {
	...
	public int doStartTag() throws JspException {
		try {
			...
			pc.getOut().print(
					"<div align=\"center\"><fieldset><legend>" + legend
							+ "</legend>");
			pc.getOut().print(
			...
			pc.getOut()
					.print("<td><input class=\"inputbox\" type=\"submit\" value=\"Go\" />");

			pc.getOut().print(
					"<input type=\"hidden\" name=\"saction\" value=\""
							+ request.getParameter("saction") + "\" />");
			pc.getOut().print(
					"<input type=\"hidden\" name=\"legend\" value=\""
							+ request.getParameter("legend") + "\" />");
			pc.getOut().print(
					"<input type=\"hidden\" name=\"searchterms\" value=\""
							+ request.getParameter("searchterms") + "\" />");
			pc.getOut().print(
					"<input type=\"hidden\" name=\"searchdetail\" value=\""
							+ request.getParameter("searchdetail") + "\" />");
			pc.getOut().print(
