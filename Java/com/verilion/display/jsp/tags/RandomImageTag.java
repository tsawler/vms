...
/**
 * Displays random image from list. All images must be in same directory. Must
 * be at least two images in list, separated by commas, no spaces.
 * 
 * @author tsawler
 * 
 */
public class RandomImageTag extends BaseTag {
	...
	public int doStartTag() throws JspException {
		try {
			...
			String theImage = "<img src=\"" + path + "/"
					+ sImages[randomNumber] + "\" alt=\"" + sAlts[randomNumber]
					+ "\" height=\"" + sHeights[randomNumber] + "\" width=\""
					+ sWidths[randomNumber] + "\" style=\"border: 0;\" />";
