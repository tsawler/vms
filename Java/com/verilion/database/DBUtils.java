...
public class DBUtils {
	...
	public int countRowsForTable(String theTable, String theCondition,
			String theColumn) throws SQLException, Exception {

		int rowCount = 0;

		try {
			String query = "select count(" + theColumn + ") from " + theTable;
			...
			Errors.addError("DBUtils:countRowsForTable:SQLException:"
					+ e.toString());
		} catch (Exception e) {
			Errors.addError("DBUtils:countRowsForTable:Exception:"
					+ e.toString());
		} finally {
			if (rs != null) {
				rs.close();
