...
//Revisions
//------------------------------------------------------------------------------
//$Log: SingletonObjects.java,v $
//Revision 1.5.2.3.6.2.2.1.4.1  2007/03/14 00:19:42  tcs
//*** empty log message ***
//
//Revision 1.5.2.3.6.2.2.1  2005/12/03 03:21:48  tcs
//Added var
//
//Revision 1.5.2.3.6.2  2005/10/12 00:05:48  tcs
//Added stub message handler support
//
//Revision 1.5.2.3.6.1  2005/09/08 18:14:58  tcs
//Probably not necessary, but clearing out singleton on app stop
//
//Revision 1.5.2.3  2005/04/27 18:11:23  tcs
//Added systempath var
//
//Revision 1.5.2.2  2005/02/24 13:12:58  tcs
//Added hm for classobjects, and cacheTimeout values
//
//Revision 1.5.2.1  2004/12/10 18:01:19  tcs
//Added session_timeout attribute support
//
//Revision 1.5  2004/10/20 17:26:21  tcs
//added support for admin_email
//
//Revision 1.4  2004/09/17 18:28:49  tcs
//Added memory threshold attribute
//
//Revision 1.3  2004/07/12 18:39:36  tcs
//Added site description
//
//Revision 1.2  2004/06/27 02:39:35  tcs
//Removed dependence on context variables; changes for new listener logic
//
//Revision 1.1  2004/06/26 17:35:25  tcs
//Initial entry
//
//------------------------------------------------------------------------------
...
public class SingletonObjects {
   ...
   /**
    * @param hmClassMap The hmClassMap to set.
    */
   ...
   /**
    * @param myScheduler The myScheduler to set.
    */
   ...
   /**
    * @param store_max_subcategories The store_max_subcategories to set.
    */
