...
//Revisions
//------------------------------------------------------------------------------
//$Log: CustomerMessages.java,v $
//Revision 1.1.2.9.2.1  2009/07/22 16:29:32  tcs
//*** empty log message ***
//
//Revision 1.1.2.9  2007/03/19 00:46:02  tcs
//added method
//
//Revision 1.1.2.8  2007/02/13 00:26:00  tcs
//*** empty log message ***
//
//Revision 1.1.2.7  2007/02/12 23:30:04  tcs
//Added a couple of methods for sent messages
//
//Revision 1.1.2.6  2007/02/12 23:27:23  tcs
//Added addSentMessage method
//
//Revision 1.1.2.5  2007/02/12 19:30:26  tcs
//Added a couple of methods
//
//Revision 1.1.2.4  2007/02/12 12:08:03  tcs
//fixed sql typo
//
//Revision 1.1.2.3  2007/02/12 11:37:14  tcs
//Added method to get count for new messages for customer
//
//Revision 1.1.2.2  2007/02/12 11:32:52  tcs
//Removed update method (not used)
//
//Revision 1.1.2.1  2007/02/10 01:12:24  tcs
//Initial entry
//
//------------------------------------------------------------------------------
...
public class CustomerMessages implements DatabaseInterface {
    ...
    * @throws Exception
    */
   public XDisconnectedRowSet getAllMessagesForCustomerId() throws SQLException, Exception {
      try {
         ...
         Errors.addError("CustomerMessages:getAllMessagesForCustomerId:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getAllMessagesForCustomerId:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
   ...
   public RowSetDynaClass getAllMessagesForCustomerIdDyaBean() throws SQLException, Exception {
      ...
      try {
         ...
         Errors.addError("CustomerMessages:getAllMessagesForCustomerIdDyaBean:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getAllMessagesForCustomerIdDyaBean:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
...
public RowSetDynaClass getAllSentMessagesForCustomerIdDyaBean() throws SQLException, Exception {
      ...
      try {
         ...
         Errors.addError("CustomerMessages:getAllSentMessagesForCustomerIdDyaBean:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getAllSentMessagesForCustomerIdDyaBean:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
   ...
   public int getNewMessageCountForCustomerId() throws SQLException, Exception {
      ...
      try {
         String query = "select count(customer_message_id) from customer_messages "
            + sCustomWhere
            + " and to_user_id = ? and is_read_yn = 'n'";
         ...
         Errors.addError("CustomerMessages:getNewMessageCountForCustomerId:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getNewMessageCountForCustomerId:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
    ...
    * @throws Exception
    */
   public XDisconnectedRowSet getOneMessageById() throws SQLException, Exception {
      try {
         ...
         Errors.addError("CustomerMessages:getOneMessageById:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getOneMessageById:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
   ...
   public XDisconnectedRowSet getOneSentMessageById() throws SQLException, Exception {
      try {
         ...
         Errors.addError("CustomerMessages:getOneSentMessageById:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:getOneSentMessageById:Exception:" + e.toString());
      } finally {
         if (rs != null) {
            rs.close();
            rs = null;
   ...
   public void setMessageToRead(int inId) throws SQLException, Exception {
      try {
         ...
         Errors.addError("CustomerMessages:setMessageToRead:SQLException:" + e.toString());
      } catch (Exception e) {
         Errors.addError("CustomerMessages:setMessageToRead:Exception:" + e.toString());
      } finally {
         if (pst != null) {
            pst.close();
            pst = null;
