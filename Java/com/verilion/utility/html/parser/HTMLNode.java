...
private Vector parseChildren(Enumeration src) {
   ...
   private static String[] defaultStandaloneList = { "area", "base",
         "basefont", "bgsound", "br", "col", "dd", "dl", "dt", "font", "frame",
         "hr", "img", "input", "isindex", "li", "link", "meta", "nextid",
         "option", "overlay", "p", "param", "tab", "wbr", "!", "!--" };
   ...
   /**
    * Utility method which we use to find out exactly which nodes are in
    * the default standalone list. The default list is printed to the standard
    * output.
    */
