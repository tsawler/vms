...
public class TagToken {
	...
	/**
	 * Sets the name of the token and also whether it is a begin or an end
	 * token.
	 * 
	 * @param name
	...
	/**
	 * Adds a attribute to the list using the given string. The string may
	 * either be in the form 'attribute' or 'attribute=value'.
	 * 
	 * @param s
