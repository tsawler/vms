...
/**
 * This represents a single HTML tag. Each TagToken has a name and a list of
...
public class TagToken {
   ...
   /**
    * Constructs a new TagToken converting the specified string into a token
    * name and a list of attributes with values.
    * 
   ...
   /**
    * Returns the value of the specified attribute or null if the attribute does
    * not exist.
    * 
    * @param name the name of the attribute.
    */
   ...
   /**
    * Adds a attribute to the list using the given string. The string may either
    * be in the form 'attribute' or 'attribute=value'.
    * 
   ...
   /**
    * Tokenizes the given string and uses the resulting vector to to build up
    * the TagToken's attribute list.
    * 
   ...
   /**
    * This method tokenizes the given string and returns a vector of its
    * constituent tokens. It understands quoting and character escapes.
    * 
