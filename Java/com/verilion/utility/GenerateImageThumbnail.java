	...
	public File process() {
		...
		try {
			...
			BufferedOutputStream out = new BufferedOutputStream(
					new FileOutputStream(new File(SingletonObjects
							.getInstance().getUpload_path()
							+ "/UserImages/tn_"
							+ file.getName())));
			System.out.println("writing "
					+ SingletonObjects.getInstance().getUpload_path()
					+ "/UserImages/tn_" + file.getName());
			...
			fileOut = new File(SingletonObjects.getInstance().getUpload_path()
					+ "/UserImages/tn_" + file.getName());
			out.close();
