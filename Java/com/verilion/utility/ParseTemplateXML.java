...
public class ParseTemplateXML {
	...
	public static void parseFile(String myFileName) throws IOException,
		...
		try {
			...
			digester.addObjectCreate("vcmstemplate/details", TemplateObject.class);

			// set different properties of Contact instance using specified
			// methods
			digester.addCallMethod("vcmstemplate/details/template-name", "setTemplate_name", 0);
			digester.addCallMethod("vcmstemplate/details/author", "setAuthor", 0);
			digester.addCallMethod("vcmstemplate/details/author-email", "setAuthor_email", 0);
			digester.addCallMethod("vcmstemplate/details/copyright", "setCopyright", 0);
			digester.addCallMethod("vcmstemplate/details/author-url", "setAuthor_url", 0);
			digester.addCallMethod("vcmstemplate/details/version", "setVersion", 0);
			digester.addCallMethod("vcmstemplate/details/html-template", "setHtml_filename", 0);
			digester.addCallMethod("vcmstemplate/details/stylesheet", "setCss", 0);
			...
			// methods
			digester.addCallMethod("vcmstemplate/images/image-filename", "setImage_name", 0);

			// call appropriate method when we see vcmstemplate/details
			digester.addSetNext("vcmstemplate/details", "DisplayTemplateXMLValues");
			
			// call appropriate method when we see vcmstemplate/images
			digester.addSetNext("vcmstemplate/images", "DisplayTemplateImageNames");
			
			// now that rules and actions are configured, start the parse
			//ParseTemplateXML abp = (ParseTemplateXML) digester.parse(new File(myFileName));
	...
	public static class TemplateObject {
		...
		/**
		 * @param html_filename The html_filename to set.
		 */
	 ...
	 * 
	 * @param templateObject  - a templateObject object
	 * 
	...
	public void DisplayTemplateXMLValues(TemplateObject templateObject) {
		System.out.println("Template Name: " + templateObject.getTemplate_name());
		System.out.println("Author:        " + templateObject.getAuthor());
		System.out.println("Author email:  " + templateObject.getAuthor_email());
		...
		System.out.println("HTML filename: " + templateObject.getHtml_filename());
	}
