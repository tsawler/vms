...
public final static String NewLinesToBr(String theText) {
   ...
   /**
    * Removes special HTML characters and replaces with appropriate
    * value (i.e. &copy; becomes the copyright symbol)
    * 
    * @param theText
    * @return the supplied text with &value; replaced with appropriate
    * text
    */
