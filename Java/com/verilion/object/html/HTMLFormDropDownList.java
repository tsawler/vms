...
public class HTMLFormDropDownList {
	 ...
	 * @throws Exception
	 */
	public static String makeDropDownList(String formName, int selectedValue,
			String theAction, XDisconnectedRowSet rs, String idCol,
			String valCol, String buttonName) throws Exception {
		...
		try {
			...
			theMenu += "</select>";
			theMenu += "&nbsp;<input class=\"inputbox\" type=\"submit\" value = \""
					+ buttonName + "\">";
			theMenu += "</form>";
	...
	public static String makeDropDownList(String formName, int selectedValue,
			String theAction, XDisconnectedRowSet rs, String idCol,
			String valCol, String buttonName, String javascript)
			throws Exception {
		...
		try {
			// build our menu
			theMenu = "<form action=\"" + theAction + "\" method = \"post\">";
			theMenu += "<select " + javascript + " class=\"inputbox \" name=\""
					+ formName + "\">";
			if (selectedValue > 0) {
				while (rs.next()) {
					theMenu += "<option value=\"";
	...
	public static String makeDropDownList(String formName, int selectedValue,
			String theAction, XDisconnectedRowSet rs, String idCol,
			String valCol, String buttonName, String javascript,
			String formname, String elementid) throws Exception {

		String theMenu = "";

		try {
			// build our menu
			theMenu = "<form action=\"" + theAction + "\" name=\"" + formname
					+ "\" method = \"post\">\n";
			theMenu += "<select id=\"" + elementid + "\" " + javascript
					+ " class=\"inputbox \" name=\"" + formName + "\">\n";
			if (selectedValue > 0) {
				while (rs.next()) {
					theMenu += "<option value=\"";
					theMenu += rs.getInt(idCol);
	 ...
	 *            - The name we want our submit button to have
	 * @param isDisabled
	 *            - true to disable the buttons, false to leave active
	 * @return String - the complete HTML form
	 * @throws Exception
	 */
	public static String makeDropDownList(String formName, int selectedValue,
			String theAction, XDisconnectedRowSet rs, String idCol,
			String valCol, String buttonName, boolean isDisabled)
			throws Exception {
		...
		try {
			...
			if (isDisabled) {
				...
				theMenu += "<select disabled class=\"inputbox \" name=\""
						+ formName + "\">";
			}
			if (selectedValue > 0) {
				while (rs.next()) {
			...
			theMenu += "</select>";
			if (isDisabled) {
				theMenu += "&nbsp;<input disabled class=\"inputbox\" type=\"submit\" value = \""
						+ buttonName + "\">";
			} else {
				theMenu += "&nbsp;<input class=\"inputbox\" type=\"submit\" value = \""
						+ buttonName + "\">";
	 ...
	 * @throws Exception
	 */
	public static String makeDropDownListSnippet(String selectName,
			int selectedValue, ResultSet rs, String idCol, String valCol,
			int firstVal, String firstValDesc) throws Exception {
		...
		try {
			...
			e.printStackTrace();
			Errors.addError("HTMLFormDropDownList.makeDropDownListSnippet:Exception:"
					+ e.toString());
		} finally {
			if (rs != null) {
				rs.close();
	...
	public static String makeDropDownListSnippet(String selectName,
			int selectedValue, ResultSet rs, String idCol, String valCol,
			int firstVal, String firstValDesc, String javascript)
			throws Exception {
		...
		try {
			// build our menu
			theMenu = "<select class=\"inputbox\" " + javascript + " name=\""
					+ selectName + "\">";
			if (firstValDesc != "") {
				theMenu += "<option value=\"" + firstVal + "\">";
				theMenu += firstValDesc;
	...
	public static String makeDropDownListSnippet(String formName,
			int selectedValue, String theAction, XDisconnectedRowSet rs,
			String idCol, String valCol, String buttonName, String javascript,
			String elementid, String firstVal, String firstValDesc)
			throws Exception {
	...
	public static String makeDropDownListSnippet(String selectName,
			int selectedValue, ResultSet rs, String idCol, String valCol,
			int firstVal, String firstValDesc, String javascript, String style)
			throws Exception {
		...
		try {
			// build our menu
			theMenu = "<select class=\"" + style + "\" " + javascript
					+ " name=\"" + selectName + "\">";
			if (firstValDesc != "") {
				theMenu += "<option value=\"" + firstVal + "\">";
				theMenu += firstValDesc;
