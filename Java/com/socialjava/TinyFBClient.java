...
public class TinyFBClient {
	...
	/*
	 * public TinyFBClient( TinyFBClient tiny){ this(tiny.apiKey,
	 * tiny.secretKey, tiny.session); this.version=tiny.version;
	 * this.format=tiny.format; standardParms.put("v", this.version);
