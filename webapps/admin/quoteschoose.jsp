    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/quoteschoose/jpage/1/p/QuotesChoose/admin/1/content.do" export="false" id="plinksobj" pagesize="<%=pagesize%>"  class="tabledatacollapse" style="width: 100%" >
			 <display:column property="quote_name" title="Poll" href="/admin/jpage/1/p/EditQuote/a/editquote/class/quotes/admin/1/content.do?id=0&edit=false&cancelPage=/quoteschoose/jpage/1/p/QuotesChoose/admin/1/content.do?edit=false" paramId="id" paramProperty="quote_id"  />
