    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/gallerychoose/jpage/1/p/gallery/admin/1/content.do" 
				...
				style="width: 100%"  >
			  <display:column property="gallery_name" title="Gallery" href="/browsegallery/jpage/1/p/browsegallery/admin/1/content.do?" paramId="id" paramProperty="gallery_id" sortable="true" headerClass="sortable" />
			</display:table>
		</div>
