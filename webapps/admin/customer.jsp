...
RowSetDynaClass resultset = myCustomer.getAllMembersDynaBean();
    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/customer/jpage/1/p/SearchCustomers/admin/1/class/customer/content.do" 
				...
				style="width: 100%"  >
			  <display:column property="customer_last_name" title="Last name" href="/admin/jpage/1/p/DisplayCustomer/a/displaycustomer/admin/1/content.do?cancelPage=/customer/jpage/1/p/SearchCustomers/admin/1/content.do&edit=false" paramId="id" paramProperty="customer_id" sortable="true" headerClass="sortable" />
			  <display:column property="customer_first_name" title="First name" href="/admin/jpage/1/p/DisplayCustomer/a/displaycustomer/admin/1/content.do?cancelPage=/customer/jpage/1/p/SearchCustomers/admin/1/content.do&edit=false" paramId="id" paramProperty="customer_id" />
			  ...
			  <display:column property="customer_status" title="Status" />
