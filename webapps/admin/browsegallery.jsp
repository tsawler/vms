...
myGt.setConn(conn);
myGt.setSSelectWhat("*");
myGt.setSCustomWhere(" and gallery_id = " + gallery_id);
...
<table style="padding: 0; border: 1px solid silver; width: 100%;">
  ...
  <tr>
    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/browsegallery/jpage/1/p/browsegallery/admin/1/content.do?id=<%=gallery_id%>" 
				export="true" 
				defaultsort="1" 
				id="cust"  
				pagesize="<%=pagesize%>"  
				...
				style="width: 100%"  >
			  <display:column property="title" title="Image" href="/galleryitemdetail/jpage/1/p/galleryitemdetail/admin/1/content.do" paramId="id" paramProperty="gallery_detail_id" sortable="true" headerClass="sortable" />
			</display:table>
		</div>
